...
[Git Source](https://github.com/ArrakisFinance/arrakis-modular/blob/b9ae3a6dd7145e0f69f817dcb31abd79f8e19310/src/interfaces/IArrakisPublicVaultRouterV2.sol)
...
|`resolver_`|`address`|resolver to use to perform get mint amounts.|
...
### LogWhitelistResolvers

```solidity
event LogWhitelistResolvers(address[] resolvers);
```

### LogBlacklistResolvers

```solidity
event LogBlacklistResolvers(address[] resolvers);
```
...
### ResolverAlreadyWhitelisted

```solidity
error ResolverAlreadyWhitelisted();
```

### NotWhitelistedResolver
